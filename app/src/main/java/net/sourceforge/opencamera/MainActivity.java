...
import net.sourceforge.opencamera.camerarig.BasicControlSource;
import net.sourceforge.opencamera.camerarig.SerialCameraController;
import net.sourceforge.opencamera.camerarig.UsbService;
...
public class MainActivity extends Activity {
    ...
    private BasicControlSource controlSource;
    public SerialCameraController serialCom;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case UsbService.MESSAGE_FROM_SERIAL_PORT:
                    ...
                    mActivity.get().serialCom.onDataRecieved(data.toString());
